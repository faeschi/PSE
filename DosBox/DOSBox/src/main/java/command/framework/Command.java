...
public abstract class Command {
    ...
    /**<b>Must be overwritten</b> by the concrete commands if something must be checked.
     ...
     * - false otherwise
     */
    protected abstract boolean checkNumberOfParameters(int numberOfParametersEntered);

	/**<b>Must be overwritten</b> by the concrete commands if at least the value of one parameter must be checked.
	 ...
	 */
	protected abstract boolean checkParameterValues(IOutputter outputter);
