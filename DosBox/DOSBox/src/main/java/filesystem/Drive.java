 ...
 * 
 * Responsibilities:<br>
 * - manipulates objects in the composition through the Component interface.<br>
 * - owns the root directory which is the top of the directory tree.<br>
 * - knows the current directory on which most of the commands must be performed.<br>
 */
