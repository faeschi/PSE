...
public class DirectoryTest {
    ...
    @Test
    public void getNumberOfContainedDirectories_2DirectoriesInRoot_Returns2() {
    	assertEquals(2, rootDir.getNumberOfContainedDirectories());
    }

    @Test
    public void getNumberOfContainedDirectories_0DirectoriesSubDir1_Returns0() {
    	assertEquals(0, subDir1.getNumberOfContainedDirectories());
    }

    @Test
    public void getNumberOfContainedDirectories_2MoreSubDirectories_Returns4() {
    	subDir1.add(new Directory("SubSubDir1"));
    	subDir1.add(new Directory("SubSubDir2"));
    	assertEquals(4, rootDir.getNumberOfContainedDirectories());
    }
}
